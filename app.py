...
def add_produto(form: ProdutoSchema):
    ...
    Retorna uma representação dos alunos e comentários associados.
    """
    produto = Produto(
        nome=form.nome,
...
def add_comentario(form: ComentarioSchema):
    """Adiciona de um novo comentário à um Alunos cadastrado na base identificado pelo id
    ...
    # adicionando o comentário ao Aluno
